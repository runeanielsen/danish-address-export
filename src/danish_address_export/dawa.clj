...
(defn map-unit-address
  ...
  {:access-address-id (:adgangsadresseid dawa-unit-address)
   ...
   :effective-date (:ikrafttrædelsesdato dawa-unit-address)
   :journal-number (:journalnummer dawa-unit-address)
   :esdh-reference (:esdhreference dawa-unit-address)
   :source (:kilde dawa-unit-address)
...
(defn map-access-address
  ...
  {:access-address-id (:adgangsadresseid dawa-access-address)
   ...
   :technical-standard (:tekniskstandard dawa-access-address)
   :height (:højde dawa-access-address)
   :accuracy (:nøjagtighed dawa-access-address)
   :journal-number (:journalnummer dawa-access-address)
   :esdh-reference (:esdhreference dawa-access-address)
   :effective-date (:ikrafttrædelsesdato dawa-access-address)
   :technical-direction (:tekniskretning dawa-access-address)
   :source (:kilde dawa-access-address)
   :access-point-id (:adgangspunktid dawa-access-address)
   :waypoint-id (:vejpunkt_id dawa-access-address)
   :owner-code (:ejerlavkode dawa-access-address)
   :house-number-source (:husnummerkilde dawa-access-address)
   :esr-property-number (:esrejendomsnr dawa-access-address)
